    ...
    return (
      <div>
        ...
        <form onSubmit={ this.update.bind(this) }>
          <label htmlFor="update-superhero-id">Yes or Not: </label>
          <input id="update-superhero-id" type="number"/>
          <br/>
          <label htmlFor="update-name">Level of Flame: </label>
          <input id="update-name" type="text"/>
          <br/>
          <label htmlFor="update-superpowers-count">Analog value: </label>
